        ...
        <div class="container">
            <form class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="txtUserPhone" placeholder="123456789" CssClass="col-md-2 form-control" runat="server" TextMode="Phone" pattern="[0-9]{10}" required></asp:TextBox>
                ...
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="inputpincode" CssClass="col-md-3 form-control" placeholder="421003" runat="server" pattern="[0-9]{6}" min="0" MaxLength="6" required></asp:TextBox>
        ...
        <div class="container">
            <form class="form-horizontal" action="/" method="post">
                ...
                <div class="form-group row">
                    ...
                    <asp:FileUpload ID="filesalary" PlaceHoler="" runat="server" Font-Size="Small" CssClass="col-md-2" accept=".png,.jpg,.jpeg,.gif,.pdf" />
                    ...
                    <asp:TextBox ID="totalearning" runat="server" CssClass="col-md-2 form-control" placeholder="15000" type="number" min="0.00" max="100000.00" step="1.00" MaxLength="7" required />
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="txtstd" CssClass="col-md-3 form-control" placeholder="" runat="server" type="number" min="0" MaxLength="4" required />
                </div>
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="txttotalmark" CssClass="col-md-3 form-control" placeholder="555" runat="server" pattern="^[0-9]{2}$" min="0" MaxLength="3" required />
                    <label for="text" class="col-md-2 col-form-label font-weight-bold">Percentage/CGPA:<span class="ion-android-star" style="color: red"></span></label>
                    <asp:TextBox ID="txtpercentage" CssClass="col-md-3 form-control" placeholder="80 %" pattern="^[0-9]{2}$" min="0" MaxLength="4" runat="server" required />
                </div>
                <div class="form-group row">
                    <label for="text" class="col-md-6 col-form-label font-weight-bold">Have you own Prize/ award/ scholarship- If yes describe:</label>
                    <asp:TextBox ID="txtscholarship" CssClass="col-md-4 form-control" runat="server" TabIndex="21" />
                </div>
                <div class="form-group row">
    ...
    <asp:Panel ID="third" runat="server">
        ...
        <div class="container">
            <form class="form-horizontal" action="/" method="post">
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <span class="font-weight-bold">1) Guardian photo <span class="ion-android-star" style="color: red"></span></span>
                    </div>
                    <asp:FileUpload ID="filedadmomphoto" runat="server" CssClass="custom-file col-md-6" accept=".png,.jpg,.jpeg,.gif,.pdf" required />
                    ...
                    <asp:FileUpload ID="filestudent" runat="server" CssClass="custom-file col-md-6" accept=".png,.jpg,.jpeg,.gif,.pdf" required />
                    <br />
                    <hr />
                    <div class="col-md-4">
                        <span class="font-weight-bold">3) Aadhar Photo<span class="ion-android-star" style="color: red"></span></span>
                    </div>
                    <asp:FileUpload ID="fileaadhar" runat="server" CssClass="custom-file col-md-6" accept=".png,.jpg,.jpeg,.gif,.pdf" required />
                    <br />
                    <hr />
                    <div class="col-md-4">
                        <span class="font-weight-bold">4) Light Bill <span class="ion-android-star" style="color: red"></span></span>
                    </div>
                    <asp:FileUpload ID="filelight" runat="server" CssClass="custom-file col-md-6" accept=".png,.jpg,.jpeg,.gif,.pdf" required />
                    <br />
                    <hr />
                    <div class="col-md-4">
                    ...
                    <asp:FileUpload ID="filecollage" runat="server" CssClass="custom-file col-md-6" accept=".png,.jpg,.jpeg,.gif,.pdf" required />
                </div>
                <div class="form-group row">
