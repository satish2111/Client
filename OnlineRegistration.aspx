        ...
        <div class="container">
            <form class="form-horizontal" action="/" method="post">
                ...
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="totalearning" runat="server" CssClass="col-md-2 form-control" placeholder="15000" min="0" required />
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="txtstd" CssClass="col-md-3 form-control" placeholder="1" runat="server"  min="0" required />
                </div>
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="txttotalmark" CssClass="col-md-3 form-control" placeholder="555" runat="server" min="0"  required />
                    ...
                    <asp:TextBox ID="txtpercentage" CssClass="col-md-3 form-control" placeholder="80 %" min="0" runat="server" required />
                </div>
                <div class="form-group row">
